        ...
        "undefined" != typeof define && define.amd && define([],
            ...
            c.Splitter.prototype.splitChildren = function(a, b, c, d) {
                for (var e = a.childNodes,
                         f = e.length - 1; f >= 0; f--) {
                    var g = e[f];
                    1 === g.nodeType && (g.className += " " + d + "letter", c.insertBefore(g, c.firstChild), this.elements.push(g))
                }
            ...
            c.Timing.throttle = function(a, b, c) {
                ...
                return function() {
                    ...
                    var f = window.performance.now(),
                        g = arguments; ! isNaN(d) && d + b > f ? (isNaN(e) || clearTimeout(e), e = setTimeout(function() {
                            d = f,
                                a.apply(c, g)
                        },
